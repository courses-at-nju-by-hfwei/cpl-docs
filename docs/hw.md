...
共6题，其中有1道客观题、5道主观题，*6选1即可**，若都做了，取最高分。

- 客观题交由 OJ 自动评分，根据通过的测试点客观给分。可及时看到得分，与平常编程练习**完全相同**，可多次提交，取最高分。
- 主观题由各助教人工评判，根据题目要求与[项目要求](project)主观评分。只能事后看到成绩。助教会根据各题难度，综合考虑给分。可多次提交，取最后一次提交。
